...
const AppContent: React.FC = () => {
        ...
        case 'settings': return (
          <div className="flex items-center justify-center h-full text-zinc-400">
              <div className="text-center bg-white p-12 rounded-3xl shadow-sm">
                  <h2 className="text-3xl font-bold mb-4 text-zinc-800">Settings</h2>
    ...
    return (
        <div className="flex h-screen bg-[#FDF6E9] overflow-hidden">
          <Sidebar 
          ...
          <main className="flex-1 flex flex-col h-full relative lg:ml-[280px] transition-all duration-300">
               ...
               <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="hidden md:flex items-center gap-3 bg-white px-5 py-3 rounded-full border border-zinc-200/50 shadow-sm flex-1 max-w-lg">
                      ...
                      <div className="text-xs text-zinc-400 border-l border-zinc-200 pl-3 hidden lg:block whitespace-nowrap">
                          In: <span className="text-zinc-800 font-medium">All Modules</span>
                      </div>
                  </div>
               </div>
               ...
               <div className="flex items-center gap-3">
                  <div className="flex items-center gap-3 pl-3">
                      <div className="text-right hidden md:block">
                          <p className="text-sm font-bold text-zinc-900 leading-tight">{currentUser.name}</p>
                          <p className="text-xs text-zinc-500 uppercase tracking-wider">{currentUser.role}</p>
                      </div>
            ...
            <div className="flex-1 px-6 pb-6 overflow-hidden flex flex-col">
               ...
               <div className="flex justify-between items-end mb-4 flex-shrink-0">
                   <div>
                      <h2 className="text-3xl font-bold text-[#1A1A1A] tracking-tight">{getViewTitle()}</h2>
                      <p className="text-zinc-500 text-sm mt-1">Welcome back, get ready for a busy day.</p>
                   </div>
               </div>
