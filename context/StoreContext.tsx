...
import { MOCK_PRODUCTS, MOCK_CUSTOMERS, MOCK_TRANSACTIONS, CURRENT_USER } from '../constants';
...
interface StoreContextType {
  ...
  clearCart: () => void;
  completeSale: (method: 'Cash' | 'Debit Card' | 'Transfer', customerId?: string) => Transaction;
  updateProductStock: (productId: string, newStock: number, timestamp?: string) => void;
...
export const StoreProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const completeSale = (method: 'Cash' | 'Debit Card' | 'Transfer', customerId?: string): Transaction => {
  ...
  const updateProductStock = (productId: string, newStock: number, timestamp?: string) => {
