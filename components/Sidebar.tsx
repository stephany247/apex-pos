    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-8">
          <div>
            <h3 className="px-4 text-xs font-medium text-zinc-600 uppercase tracking-wider mb-2">
              General
            </h3>
            <nav className="space-y-1">
              {generalItems.map((item) => (
                ...
                >
                  <div
                    className={`${currentView === item.id ? "text-[#FDE047]" : "text-current group-hover:text-white transition-colors"}`}
                  >
                    {item.icon}
                  </div>
